<?php
// Assume $eventDTO is provided by the controller from the database.

// Build $heroData array using the DTO data.
// For Teylers we want both buttons.
$heroData = [
