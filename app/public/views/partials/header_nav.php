<nav class="navbar nav-underline navbar-expand-lg" data-bs-theme="dark">
  <div class="container-fluid">
    <a class="navbar-brand ms-3" href="/">
      <img src="/assets/images/logo.svg" class="img-fluid logo" alt="Logo The Haarlem Festival with a windmill">
    </a>
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
      <ul class="navbar-nav mb-2 mb-lg-0 ms-3 gap-3">
        ...
        <li class="nav-item">
          <!-- Conditional link for profile or register -->
      ...
      <div>
        <!-- Conditional button for sign in or sign out -->
